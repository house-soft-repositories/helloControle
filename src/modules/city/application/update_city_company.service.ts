  ...
  implements IUpdateCityCompanyUseCase
{
  ...
  async execute(
    ...
    const updatedCompany = new CityCompanyEntity({
      ...
      cep: param.cep ?? existingCompany.cep,
      logradouro: param.logradouro ?? existingCompany.logradouro,
      numero: param.numero ?? existingCompany.numero,
      bairro: param.bairro ?? existingCompany.bairro,
